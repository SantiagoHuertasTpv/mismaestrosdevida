...
<div class="max-w-3xl mx-auto text-center space-y-8 py-12 px-4">
    ...
    <div class="space-y-6 text-gray-200 text-lg md:text-xl leading-relaxed font-light italic">
        <p>No tuve una infancia fácil ni un entorno familiar que pudiera servirme de guía. Hubo carencias, mal ambiente y ausencias que, con el tiempo, entendí que no deberían formar parte del crecimiento de ningún niño. Durante años pensé que eso me había dejado incompleto, sin referencias claras.</p>
        ...
        <p><strong class="text-white">Y fue desde ahí desde donde empecé a reconocer a quienes sí podían enseñarme algo.</strong> En este libro cuento como fui creciendo desde niño en los años 80 y sucesivos años, mientras iban apareciendo esas personas especiales.</p>

        <p>Que no eran familia, ni héroes, ni salvadores sino personas normales, a veces incluso imperfectas, que sin proponérselo dejaron una huella profunda en mí. No me dieron discursos ni recetas, pero me ofrecieron algo mucho más valioso: ejemplo, gestos, presencias. <strong class="text-white">Supieron estar de la forma correcta y con ellos pude crecer.</strong></p>

        <p>Si has tenido una infancia estable, quizá estas páginas te ayuden a comprender mejor a quienes no partieron del mismo lugar. Y si creciste sin un referente familiar sólido o te paso algo, tal vez aquí entiendas el valor que puede tener un maestro de vida cuando más se necesita.</p>
